...
while True:
    ...
    font4 = pygame.font.Font('Starjedi.ttf', 30)
    title3 = font4.render(f"High Score: {highscore}",True,(255,255,255))
    title3_rect = title3.get_rect(center = (1150,500))

    fontN = pygame.font.Font('Oswald.ttf',35)
    fontI = pygame.font.Font('Oswald.ttf',20)
